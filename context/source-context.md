...
Canonical design-system title: it's an online platform Design System

it's an online platform where people share their projects to the platform and other participators look at the projects and ask to join and the project initiators can accept or deny join request.
...
I want to make the website boutique and high-end. and the project dashboard should be at the landing page.
